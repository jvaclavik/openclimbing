...
<li>in <a href="https://www.geeksforgeeks.org/how-to-enable-webgl-on-chrome/">Chrome, Chromium, Brave, Edge</a></ul>`,
  ...
  'tick.style_description_PJ': '完登なしでルートに取り組むこと：トライ、ハングドッグ、ムーブの研究、または進行中のプロジェクト。',
...
<br/><br/>これが間違いである場合は、手動で値を元に戻して再度保存できます。`,
  ...
  'layerswitcher.3d': '3D',
  'layerswitcher.3d_hint': 'ドラッグして傾ける・回転する',
  'layerswitcher.3d_tilt': '傾き',
  'layerswitcher.3d_rotate': '回転',
  'layerswitcher.3d_reset_north': '北を上に',
  'layerswitcher.shadows': '日陰',
  'layerswitcher.shadows_zoom_in': '影を表示するには地図を拡大してください。',
  'layerswitcher.shadows_morning': '午前',
  'layerswitcher.shadows_afternoon': '午後',
  ...
  'add_new_crag.menu_link': '新しいクライミングエリアを追加',
  'add_new_crag.banner_text': 'マーカーを岩場の場所に移動してください。ルートは次のステップで追加できます。',
  'add_new_crag.continue_button': '続ける',
  'add_new_crag.zoom_in': '岩場を追加するには、ズームインしてください。',
};
