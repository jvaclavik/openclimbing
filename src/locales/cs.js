export default {
  ...
  'offline.download_button': 'Stáhnout offline',
  'offline.updating': 'Aktualizuji…',
  'offline.downloading': 'Stahuji… __percent__ %',
  'offline.downloaded': 'Staženo offline',
  'offline.update_button': 'Aktualizovat',
  'offline.download_error': 'Uložení selhalo',
  'offline.unsupported': 'Tento prohlížeč offline ukládání nepodporuje',
  'offline.you_are_offline': 'Jsi offline — zobrazují se uložená data',
  'offline.menu_link': 'Offline oblasti',
  'offline.page_title': 'Offline oblasti',
  'offline.page_intro': 'Oblasti uložené v tomto zařízení. Zůstávají dostupné i bez připojení.',
  'offline.empty': 'Zatím nemáš uložené žádné oblasti. Otevři skálu nebo oblast a klikni na „Uložit offline“.',
  'offline.delete': 'Smazat',
  'offline.open': 'Otevřít',
  'offline.features_count': '__count__ prvků',
  'offline.photos_count': '__count__ fotek',
  'offline.storage_used': 'Stažené oblasti zabírají __used__',
  'offline.confirm_delete': 'Odebrat tuto uloženou oblast ze zařízení?',
