export default {
  ...
  'about.feature_open_data_desc': 'Uložená v OpenStreetMap. Navždy tvoje.',
  'about.feature_guides_title': 'Interaktivní průvodci',
  'about.feature_guides_desc': 'Topa zakreslená přímo do fotek.',
  'about.feature_photos_title': 'Komunitní fotky',
  'about.feature_photos_desc': 'Sdílené přes Wikimedia Commons.',
  'about.feature_ticks_title': 'Přelezy a žebříček',
  'about.feature_ticks_desc': 'Zapisuj přelezy, stoupej žebříčkem.',
  'about.feature_map_title': 'Šikovná mapa',
  'about.feature_map_desc': 'Srážkový radar, slunce a stín, offline export.',
  'about.feature_free_title': 'Zdarma a open source',
  'about.feature_free_desc': 'Žádné reklamy. Žádné paywally.',
