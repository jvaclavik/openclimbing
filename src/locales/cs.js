export default {
  ...
  'poi_categories.button': 'Zobrazit místa na mapě',
  'poi_categories.active': 'Zobrazeno na mapě',
  'poi_categories.most_used': 'Nejčastější',
  'poi_categories.all': 'Všechny kategorie',
  'poi_categories.clear_all': 'Skrýt vše (__count__)',
  'poi_categories.needs_zoom': 'potřebuje přiblížení __zoom__+',
  'poi_categories.shown_count': 'Na mapě zobrazeno: __count__',
  'poi_categories.zoom_in': 'Přibliž mapu, aby se místa načetla',
  'poi_categories.load_error': 'Místa se nepodařilo načíst, zkus pohnout mapou.',
  'poi_categories.group.access': 'Přístup a doprava',
  'poi_categories.group.water': 'Voda',
  'poi_categories.group.food': 'Jídlo a pití',
  'poi_categories.group.sleep': 'Spaní',
  'poi_categories.group.hygiene': 'Hygiena',
  'poi_categories.group.outdoor': 'Turistika a příroda',
  'poi_categories.group.services': 'Služby',
  'poi_categories.group.emergency': 'Nouze',
  'poi_categories.category.parking': 'Parkoviště',
  'poi_categories.category.bus_stop': 'Zastávka autobusu',
  'poi_categories.category.train_station': 'Vlak / tramvaj',
  'poi_categories.category.aerialway_station': 'Lanovka',
  'poi_categories.category.fuel': 'Čerpací stanice',
  'poi_categories.category.charging_station': 'Nabíječka',
  'poi_categories.category.bicycle_parking': 'Stojan na kolo',
  'poi_categories.category.drinking_water': 'Pitná voda',
  'poi_categories.category.spring': 'Pramen',
  'poi_categories.category.water_tap': 'Kohoutek',
  'poi_categories.category.water_well': 'Studna',
  'poi_categories.category.restaurant': 'Restaurace',
  'poi_categories.category.pub': 'Hospoda a bar',
  'poi_categories.category.cafe': 'Kavárna',
  'poi_categories.category.fast_food': 'Rychlé občerstvení',
  'poi_categories.category.grocery': 'Potraviny',
  'poi_categories.category.bakery': 'Pekárna',
  'poi_categories.category.ice_cream': 'Zmrzlina',
  'poi_categories.category.camp_site': 'Kemp',
  'poi_categories.category.caravan_site': 'Kemp pro karavany',
  'poi_categories.category.hut': 'Horská bouda',
  'poi_categories.category.shelter': 'Přístřešek',
  'poi_categories.category.lodging': 'Hotel a hostel',
  'poi_categories.category.toilets': 'Toalety',
  'poi_categories.category.shower': 'Sprcha',
  'poi_categories.category.waste_basket': 'Odpadkový koš',
  'poi_categories.category.laundry': 'Prádelna',
  'poi_categories.category.viewpoint': 'Vyhlídka',
  'poi_categories.category.peak': 'Vrchol',
  'poi_categories.category.guidepost': 'Rozcestník',
  'poi_categories.category.info_board': 'Informační tabule',
  'poi_categories.category.picnic_site': 'Místo na piknik',
  'poi_categories.category.firepit': 'Ohniště a gril',
  'poi_categories.category.bench': 'Lavička',
  'poi_categories.category.cave_entrance': 'Vstup do jeskyně',
  'poi_categories.category.waterfall': 'Vodopád',
  'poi_categories.category.swimming': 'Koupání',
  'poi_categories.category.atm': 'Bankomat a banka',
  'poi_categories.category.pharmacy': 'Lékárna',
  'poi_categories.category.doctor': 'Lékař',
  'poi_categories.category.outdoor_shop': 'Outdoor a sport',
  'poi_categories.category.bicycle_repair': 'Servis kol',
  'poi_categories.category.post': 'Pošta',
  'poi_categories.category.mountain_rescue': 'Horská služba',
  'poi_categories.category.hospital': 'Nemocnice',
  'poi_categories.category.defibrillator': 'Defibrilátor',
  'poi_categories.category.emergency_phone': 'Tísňový telefon',
  'poi_categories.category.police': 'Policie',
  'poi_categories.category.fire_station': 'Hasiči',
