...
export default {
  ...
  'homepage.github_link': `አዳዲስ እና ተጨማሪ መገልገያዎችን በ <a href="https://github.com/jvaclavik/openclimbing" target='_blank'>GitHub</a> ተጠቅመው ጥቆማ መስጠት ይችላሉ።`,
...
ያደረጉትን ማሻሻያ (ለውጥ) ምንጩን በማስቀመጥ ማጠናከር ተገቢ ነው። (ድረ-ገፅ፣ ፎቶ ወዘ).`,
  ...
  'layerswitcher.3d': '3D',
  'layerswitcher.3d_hint': 'ጎትት በማድረግ አንዘርና አዙር',
  'layerswitcher.3d_tilt': 'ማዘንበል',
  'layerswitcher.3d_rotate': 'ማዞር',
  'layerswitcher.3d_reset_north': 'ሰሜን ወደ ላይ',
  'layerswitcher.shadows': 'የፀሐይ ጥላዎች',
  'layerswitcher.shadows_zoom_in': 'ጥላዎቹን ለማየት ካርታውን አቅርብ።',
  'layerswitcher.shadows_morning': 'ጥዋት',
  'layerswitcher.shadows_afternoon': 'ከሰዓት በኋላ',
  'layerswitcher.shadows_now': 'አሁን',
