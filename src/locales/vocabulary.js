...
export default {
  ...
  'featurepanel.fee.free_access': 'Free access',
  'featurepanel.fee.required': 'Entrance fee required',
  'featurepanel.fee.charge_amount': '__amount__ fee',
  'featurepanel.via_ferrata.bridge': 'bridge',
  'featurepanel.via_ferrata.ladder': 'ladder',
  'featurepanel.via_ferrata.zip_line': 'zip line',
  'featurepanel.via_ferrata.net': 'net',
  'featurepanel.via_ferrata.cables': '__count__ cables',
  ...
  'uploaddialog.choose_file': 'Choose photo…',
  'uploaddialog.choose_file_hint': 'Pick an image from your device. HEIC photos from iPhone will be converted to JPG automatically.',
  ...
  'uploaddialog.drop_to_upload': 'Drop the photo here to upload it to Wikimedia Commons',
