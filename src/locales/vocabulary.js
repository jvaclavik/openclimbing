...
export default {
  ...
  'user_profile.title_prefix': 'Profile',
  'user_profile.osm_link_aria': 'OpenStreetMap profile: __name__',
  ...
  'user_profile.period_label': 'Time range',
  'user_profile.period_last_365': 'Last 365 days',
  'user_profile.period_all': 'All time',
  'user_profile.period_year': 'Year __year__',
  'user_profile.chart_monthly_points': 'Points per month',
  'user_profile.chart_cumulative_points': 'Cumulative points over time',
  'user_profile.chart_best_send_month': 'Best send per month (by grade)',
  'user_profile.chart_style_pie': 'Send styles',
  'user_profile.chart_weekday_radar': 'Weekdays activity',
  'user_profile.chart_area_days': 'Sectors by climbing days',
  'user_profile.chart_grade_distribution': 'Sends by grade',
  'user_profile.chart_grade_pyramid': 'Grade pyramid',
  'user_profile.chart_ascents_unit': 'ascents',
  'user_profile.chart_yearly_ascents': 'Ascents per year',
  'user_profile.chart_all_time_note': 'All recorded ticks',
  'user_profile.chart_cumulative': 'Cumulative ascents and points',
  'user_profile.chart_cumulative_ascents': 'Ascents',
  'user_profile.chart_progression': 'Grade progression',
  'user_profile.chart_progression_note': 'Hardest send and average of the hardest ticks each month',
  'user_profile.chart_progression_best': 'Hardest send',
  'user_profile.chart_progression_top_avg': 'Average of hardest ticks',
  'user_profile.area_unknown': 'Unknown sector',
  'user_profile.area_days_unit': 'days',
  'user_profile.chart_no_send': 'No send',
  'user_profile.points_last_year': 'Points (last 365 days)',
  ...
  'leaderboard.title': 'Climbing leaderboard',
  'leaderboard.menu_link': 'Leaderboard',
  'leaderboard.period_rolling_note': 'Ticks from __from__ to __to__ (last 365 days). Same scoring as tick points.',
  'leaderboard.period_all_note': 'All recorded ticks. Same scoring as tick points.',
  'leaderboard.period_year_note': 'Ticks in __year__. Same scoring as tick points.',
  'leaderboard.column_user': 'Climber',
  'leaderboard.column_points': 'Points',
  'leaderboard.column_ticks': 'Ticks',
  ...
  'add_new_crag.cancel_button': 'Cancel',
  ...
  'my_ticks.filter.session_label': 'Showing session from __date__ — __matched__ of __total__ ticks',
  'my_ticks.filter.highlight_label': 'Highlighting a shared ascent',
  'my_ticks.filter.show_all': 'Show full diary',
  'my_ticks.share.menu_session': 'Share day…',
  'my_ticks.share.menu_tick': 'Share this ascent…',
  'my_ticks.share.share_session_tooltip': 'Share this day',
  'my_ticks.day_header.tick_count': '· __count__ ticks',
  'my_ticks.share.text_label': 'Text for description (paste into Strava etc.)',
  'my_ticks.share.text_lead_activity_at_area': '🧗 Rock climbing in __area__:',
  'my_ticks.share.text_lead_activity_at_crag': '🧗 Rock climbing at __crag__:',
  'my_ticks.share.text_lead_activity_generic': '🧗 Rock climbing:',
  'my_ticks.share.text_lead_summary_singular': '1 route sent, hardest grade __grade__',
  'my_ticks.share.text_lead_summary_few': '__count__ routes sent, hardest grade __grade__',
  'my_ticks.share.text_lead_summary_many': '__count__ routes sent, hardest grade __grade__',
  'my_ticks.share.text_lead_summary_singular_no_grade': '1 route sent',
  ...
  'my_ticks.share.text_heading_crag_singular': '🧗 1 ascent at __crag__:',
  'my_ticks.share.text_heading_crag_few': '🧗 __count__ ascents at __crag__:',
  'my_ticks.share.text_heading_crag_many': '🧗 __count__ ascents at __crag__:',
  'my_ticks.share.text_heading_generic_singular': '🧗 1 ascent:',
  'my_ticks.share.text_heading_generic_few': '🧗 __count__ ascents:',
  'my_ticks.share.text_heading_generic_many': '🧗 __count__ ascents:',
  'my_ticks.share.text_crag_subheading': '📍 __crag__:',
  'my_ticks.share.text_unknown_crag': 'Unknown crag',
  'my_ticks.share.text_diary_heading': '📖 My diary (__date__):',
  'my_ticks.share.text_guide_single': '🗺️ Guide:',
  'my_ticks.share.text_guide_many': '🗺️ Guide:',
  ...
  'my_ticks.share.dialog_title_session': 'Share session — __date__',
  'my_ticks.share.dialog_title_tick': 'Share this ascent',
  'my_ticks.share.session_description': 'Anyone with this link will see your ticks from this day, in the context of your full diary.',
  'my_ticks.share.tick_description': 'Anyone with this link will land on your diary scrolled to this ascent with a brief highlight.',
  'my_ticks.share.link_label': 'Link',
  'my_ticks.share.close': 'Close',
  ...
  'tick.partners_from_last_route': 'Use partners from last climb',
  'tick.partners_from_last_route_none': 'No partners saved on a previous tick on this route (or any route).',
  'tick.edit_dialog_title': 'Edit tick',
  'tick.save': 'Save',
  ...
  'tick.wizard.toggle': 'Help me pick the style',
  'tick.wizard.close': 'Hide guide',
  'tick.wizard.back': 'Back',
  'tick.wizard.start_over': 'Start over',
  'tick.wizard.apply': 'Use this style',
  'tick.wizard.result_label': 'Suggested style:',
  'tick.wizard.q_clean': 'Did you climb the route cleanly?',
  'tick.wizard.q_clean_helper': 'No falls, no resting on the rope, no hanging on gear.',
  'tick.wizard.a_clean_yes': 'Yes, clean send',
  'tick.wizard.a_clean_no': 'No — I fell or rested on the rope',
  ...
  'tick.wizard.a_method_aid': 'I pulled on gear to make progress (aid)',
  'tick.wizard.a_method_solo': 'No rope at all (free solo)',
  'tick.wizard.q_first_attempt': 'Was this your first attempt on this route?',
  'tick.wizard.a_first_attempt_yes': 'Yes, first attempt ever',
  'tick.wizard.a_first_attempt_no': 'No, I had tried or worked it before',
  'tick.wizard.q_beta': 'Did you have any prior info or beta?',
  'tick.wizard.q_beta_helper': 'Watched someone climb it, got tips on holds or moves, etc.',
  'tick.wizard.a_beta_no': 'No, completely fresh',
  'tick.wizard.a_beta_yes': 'Yes, I knew the moves / had beta',
  'tick.wizard.q_preplaced': 'Were the quickdraws already in place?',
  'tick.wizard.q_preplaced_helper': 'Draws clipped to bolts before you started, so you only clipped the rope.',
  'tick.wizard.a_preplaced_no': 'No, I clipped the draws as I climbed',
  'tick.wizard.a_preplaced_yes': 'Yes, draws were pre-placed',
  ...
  'homepage.discover_more': `Show all areas`,
  'homepage.discover_more_ferrata': `Show all via ferratas`,
  'homepage.discover_more_gym': `Show all climbing gyms`,
  'homepage.gallery.title': `Climbing areas nearby`,
  'homepage.gallery.title_ferrata': `Via ferratas nearby`,
  'homepage.gallery.title_gym': `Climbing gyms nearby`,
  ...
  'homepage.gallery.nothing_in_viewport_ferrata': `No via ferratas in the current map view – showing a wider selection.`,
  'homepage.gallery.nothing_in_viewport_gym': `No climbing gyms in the current map view – showing a wider selection.`,
  ...
  'support_us.develop': `Can you code? Submit a pull request to our <link>repository</link>.`,
  ...
  'stats.areas': 'climbing areas',
  'stats.routes': 'routes',
  'stats.photos': 'drawn on photos',
  'stats.countries': 'countries',
  'stats.ferratas': 'via ferratas',
  'stats.gyms': 'climbing gyms',

  'about.hero_claim': 'The climbing guide that belongs to everyone',
  'about.hero_sub':
    'Open data, real photos, built by climbers. Like Wikipedia, but for rock – everything is stored in public databases that anyone can use, and it will always be free.',
  'about.free_banner_title': 'Free. Now and forever.',
  'about.free_banner_desc': 'No ads. No paywall. OpenClimbing is built for the climbing community.',

  'about.different_heading': 'What makes us different',
  'about.different_lead':
    'Paper guidebooks are lovely – and you pay for every area, then they go stale the day they print. Most online guides lock the data inside one company: you may add a route, but you can never take it elsewhere.',
  'about.different_us': 'OpenClimbing is built the other way around.',
  'about.compare_paper': 'Paper guidebook',
  'about.compare_paper_1': 'You pay for every single area',
  'about.compare_paper_2': 'Outdated the day it prints',
  'about.compare_paper_3': 'Covers just a handful of crags',
  'about.compare_online': 'Online guidebook',
  'about.compare_online_1': 'Data locked inside one company',
  'about.compare_online_2': 'The good content is usually paid',
  'about.compare_online_3': 'You may add routes, but never take them elsewhere',
  ...
  'about.feature_shadows_title': 'Sun & shadow',
  'about.feature_shadows_desc': 'See how the crag sits in the sun throughout the day – before you leave home.',
  'about.feature_shadows_try': 'See it on the map',
  'about.feature_bolts_title': 'Automatic bolt recognition',
  'about.feature_bolts_desc': 'AI spots bolts on the photo, so drawing a route takes seconds, not minutes.',
  'about.feature_3d_title': '3D maps',
  'about.feature_3d_desc': 'Tilt the terrain and read the cliff as if you were standing under it.',
  'about.feature_3d_try': 'Tilt the map',
  'about.feature_open_data_title': 'Free. Now and forever.',
  'about.feature_open_data_desc': 'No ads. No paywall. Routes live in OpenStreetMap – anyone can use them, in any app.',
  'about.feature_mobile_title': 'Made for your phone',
  'about.feature_mobile_desc': 'The full editor in your pocket – upload photos and draw routes on mobile.',
  'about.feature_ticks_title': 'Ticks',
  'about.feature_ticks_desc': 'Log your ascents and see how you stack up on the leaderboard.',
  'about.feature_ticks_try': 'See the leaderboard',
  'about.feature_pdf_title': 'Offline PDF export',
  'about.feature_pdf_desc': 'Download a guidebook for the crag and take it with you – no signal needed.',

  'about.cta_heading': 'Put your crag on the map',
  'about.cta_p': 'Everything you add becomes part of a worldwide open dataset – useful to every climber, in any app, forever.',
  ...
  'about.support_heading': 'Help us keep going',
  'about.support_lead': "Built in spare time, given to everyone. A share, a pull request or a coffee – that's what keeps the lights on.",
  'about.support_share': 'Share it',
  ...
  'layerswitcher.fetching_index_error': 'An error occurred while fetching the layer index',
  'layerswitcher.add_layer_title': 'Add a layer',
  'layerswitcher.sourced_prefix': 'Layers are sourced from the',
  'layerswitcher.sourced_suffix': ' list.',
  'layerswitcher.layer_label': 'Layer',
  'layerswitcher.custom_url': 'Custom URL',
  'osm_auth.logged_in_as': 'Logged in as __user__',
  ...
  'climbing_editor.choose_point_type': 'Choose point type',
  'climbing_editor.point_type_none': 'Nothing',
  'climbing_editor.point_type_bolt': 'Bolt / Ring / Hanger',
  'climbing_editor.point_type_belay': 'Belay',
  'climbing_editor.delete_point': 'Delete point',
  'climbing_editor.finish_editing': 'Finish editing',
  'climbing_editor.delete_point_question': 'Delete point?',
  'directions.add_destination': 'Add destination',
  'directions.get_my_location': 'Get my location',
  'directions.my_location': 'My location',
  'directions.geolocation_error': "Sorry, we couldn't find your location",
  'directions.hide_instructions': 'Hide instructions',
  'directions.show_instructions': 'Show instructions',
  ...
  'featurepanel.save_button': 'Save',
  'featurepanel.saved_button': 'Saved',
  'mylists.saved_to': 'Saved to __list__',
  'mylists.change': 'Change',
  'mylists.title': 'My lists',
  'mylists.create_new': 'Create new list',
  'mylists.quick_presets': 'Quick presets',
  'mylists.presets.favorites': 'Favorites',
  'mylists.presets.want_to_visit': 'Want to visit',
  'mylists.presets.want_to_climb': 'Want to climb',
  'mylists.create': 'Create',
  'mylists.cancel': 'Cancel',
  'mylists.done': 'Done',
  'mylists.edit': 'Edit',
  'mylists.delete': 'Delete',
  'mylists.change_emoji': 'Change icon',
  'mylists.name_placeholder': 'List name',
  'mylists.emoji_placeholder': 'Pick emoji',
  'mylists.color_placeholder': 'Color',
  'mylists.add_to_list': 'Add to list',
  'mylists.show_on_map': 'Show on map',
  'mylists.empty': 'This list is empty.',
  'mylists.no_lists': 'You have no lists yet.',
  'mylists.login_required': 'Please log in to save items to your lists.',
  'mylists.login_cta': 'Log in',
  'mylists.confirm_delete': 'Delete list "__name__"?',
  'mylists.item_count': '__count__ items',
  'mylists.remove_item': 'Remove from list',
  'mylists.back_to_map': 'Back to map',
  'mylists.not_found': 'List not found.',
  ...
  'climbing_orientation.ne': 'north-east',
  'climbing_orientation.e': 'east',
  'climbing_orientation.se': 'south-east',
  'climbing_orientation.s': 'south',
  'climbing_orientation.sw': 'south-west',
  'climbing_orientation.w': 'west',
  'climbing_orientation.nw': 'north-west',
  ...
  'editdialog.maximize': 'Maximize',
  'editdialog.restore_size': 'Restore size',
  'editdialog.minimize_map': 'Minimize map',
  'editdialog.show_map': 'Show map',
  'editdialog.set_location_on_map': 'Set location on map',
  'editdialog.modified': 'Changed',
  'editdialog.new_item': 'New',
  'editdialog.revert': 'Revert',
  'editdialog.map_position': 'Map position',
  'editdialog.map_position_auto': 'Automatic',
  'editdialog.map_position_right': 'Right',
  'editdialog.map_position_bottom': 'Bottom',
  'editdialog.enlarge_map': 'Enlarge map',
  'editdialog.fullscreen_map': 'Fullscreen map',
  'editdialog.exit_fullscreen_map': 'Back to split view',
  'editdialog.edit_item': 'Edit this item',
  'editdialog.move_whole_crag': 'Move the whole crag',
  ...
  'uploaddialog.open_button': 'Upload photo',
  'uploaddialog.title': 'Upload photo to Wikimedia Commons',
  'uploaddialog.close': 'Close',
  'uploaddialog.cancel': 'Cancel',
  'uploaddialog.upload': 'Upload',
  'uploaddialog.upload_all': 'Upload all',
  'uploaddialog.done': 'Done',
  'uploaddialog.login': 'Sign in',
  'uploaddialog.logout': 'Sign out',
  ...
  'uploaddialog.filename_help':
    'Pre-filled from the crag (and area, if any). You can edit it freely. A numeric suffix is added automatically if the name is taken.',
  'uploaddialog.description_label': 'Description',
  'uploaddialog.category_label': 'Categories',
  'uploaddialog.category_placeholder': 'Start typing to search categories…',
  'uploaddialog.category_help': 'Pre-filled based on country. You can add more — start typing and pick from Commons suggestions.',
  'uploaddialog.license_label': 'License',
  'uploaddialog.license_help': 'You must hold the rights to publish the photo under the chosen license.',
  'uploaddialog.license_notice':
    'The photo will be published on Wikimedia Commons under the chosen license. Make sure you have the right to publish it under it.',
  'uploaddialog.exif_location': 'EXIF GPS: __lat__, __lon__ (will be added as photo location)',
  'uploaddialog.exif_date': 'EXIF date: __date__',
  'uploaddialog.uploading': 'Uploading to Wikimedia Commons…',
  ...
  'uploaddialog.row_manual_label': 'or paste an existing filename',
  'uploaddialog.row_paste_existing': 'Paste existing photo',
  'uploaddialog.row_back_to_upload': 'Back',
  'uploaddialog.drop_to_upload': 'Drop photos here to upload them to Wikimedia Commons',
  'uploaddialog.debug_mode_on': 'Photo upload (debug) is enabled',
  ...
  'editdialog.info_edit': `Your edit will be immediately saved to the OpenStreetMap, but the time to show up depends on each map layer.<br />Please, enter only information from your own or verified sources. It is prohibited to copy copyrighted data (e.g. Google Maps). <a href="https://wiki.openstreetmap.org/wiki/How_We_Map">More info</a>`,
  'editdialog.info_edit_button': 'Edit information',
  ...
  'editdialog.parents.add_parent': 'Add parent',
  'editdialog.parents.add_climbing_crag': 'Add climbing crag',
  'editdialog.parents.add_climbing_area': 'Add climbing area',
  'editdialog.parents.not_a_relation': 'Only a relation can be a parent.',
  'editdialog.nearby.crags': 'Nearby crags',
  'editdialog.nearby.areas': 'Nearby areas',
  'editdialog.nearby.add': 'Add',
  'editdialog.nearby.in_parent': 'in __name__',
  'editdialog.nearby.no_areas': 'No nearby areas',
  'editdialog.nearby.no_crags': 'No nearby crags',
  ...
  'layerswitcher.more_maps': 'More maps',
  'layerswitcher.more_overlays': 'More overlays',
  'layerswitcher.extras': 'Map tools',
  'layerswitcher.3d': '3D',
  'layerswitcher.3d_hint': 'Drag to tilt and rotate',
  'layerswitcher.3d_tilt': 'Tilt',
  'layerswitcher.3d_rotate': 'Rotation',
  'layerswitcher.3d_reset_north': 'Reset north',
  'layerswitcher.shadows': 'Sun shadows',
  'layerswitcher.shadows_zoom_in': 'Zoom in to see the shadows.',
  'layerswitcher.shadows_morning': 'Morning',
  'layerswitcher.shadows_afternoon': 'Afternoon',
  'layerswitcher.shadows_now': 'Now',
  'layerswitcher.radar': 'Rain radar',
  'layerswitcher.radar_unavailable': 'Available in Czechia and nearby',
  'layerswitcher.radar_loading': 'Loading radar data…',
  'layerswitcher.radar_error': 'Couldn’t load radar data.',
  'layerswitcher.radar_play': 'Play',
  'layerswitcher.radar_pause': 'Pause',
  'layerswitcher.radar_latest': 'latest frame',
  'layerswitcher.radar_ago': '−__minutes__ min',
  'layerswitcher.radar_credit': 'Data © ČHMÚ · coverage Czechia and nearby',
  'layerswitcher.precip_accum': 'Precipitation total',
  'layerswitcher.precip_legend': 'Total [mm]',
  'layerswitcher.precip_loading': 'Loading precipitation data…',
  'layerswitcher.precip_for_hours': 'Total over __hours__ h',
  'layerswitcher.precip_as_of': 'as of __time__',
  'layerswitcher.precip_credit': 'Data © ČHMÚ · precipitation total · Czechia and nearby',
  'layerswitcher.opacity': 'Opacity',
  'layerswitcher.loading': 'Loading…',
  ...
  'climbing.distribute_along_line': 'Distribute',
  'climbing.distribute_along_line_tooltip': 'Distribute routes along a line',
  'climbing.done_drawing_line': 'Done',
  'climbing.route_positions_help':
    'Click on the map to add guide points — routes spread evenly along the line between them. Drag a guide point to redistribute, or drag a route to fine-tune its position. Right-click a route to snap it back onto the line, or right-click a guide point to remove it.',
  'climbing.clear_guide_points': 'Clear line',
  'climbing.edit_this_route': 'Edit this route',
  'climbing.map_style_tourist': 'Tourist',
  'climbing.map_style_outdoor': 'Outdoor',
  'climbing.map_style_satellite': 'Satellite',
  'climbing.enlarge_map': 'Enlarge map',
  'climbing.shrink_map': 'Shrink map',
  'climbing.return_to_line': 'Return to line',
  'climbing.return_to_original': 'Return to original position',
  'climbing.delete_point': 'Delete point',
  'climbing.minimize_help': 'Minimize help',
  'climbing.show_help': 'Show help',
  'climbing.display_settings': 'Display settings',
  'climbing.hide_route_names': 'Hide route names',
  'climbing.hide_difficulty': 'Hide difficulty',
  ...
  'climbingpanel.coachmark_draw_routes_title': 'You can draw climbing routes too',
  'climbingpanel.coachmark_draw_routes_body':
    'Know this sector? Help fellow climbers — trace the route lines right onto the photo, or upload a new one.',
  'climbingpanel.coachmark_dismiss': 'Dismiss',
  'climbingpanel.add_photo_tooltip': 'Add another photo',
  ...
  'climbingpanel.pdf_export_loading': 'Loading photos…',
  'climbingpanel.pdf_export_routes_count': '__count__ routes',
  ...
  'climbingareas.title_ferrata': 'Via ferratas',
  'climbingareas.title_gym': 'Climbing gyms',
  'climbingareas.tab_rock': 'Climbing',
  'climbingareas.tab_ferrata': 'Via ferrata',
  'climbingareas.tab_gym': 'Climbing gyms',
  'climbingareas.serp': 'Directory of climbing areas worldwide, grouped by country. OpenStreetMap topos and photos.',
  'climbingareas.serp_ferrata': 'Directory of via ferratas worldwide, grouped by country. Mapped in OpenStreetMap.',
  'climbingareas.serp_gym': 'Directory of climbing gyms and indoor walls worldwide, grouped by country.',
  ...
  'climbingareas.ferratas_count': '__count__ via ferratas',
  'climbingareas.gyms_count': '__count__ climbing gyms',
  ...
  'climbingareas.filter_viewport': 'Only items in the current map view',
  'climbingareas.no_areas': 'No climbing areas found.',
  'climbingareas.no_areas_in_viewport': 'No climbing areas in the current map view.',
  'climbingareas.no_ferratas': 'No via ferratas found.',
  'climbingareas.no_ferratas_in_viewport': 'No via ferratas in the current map view.',
  'climbingareas.no_gyms': 'No climbing gyms found.',
  'climbingareas.no_gyms_in_viewport': 'No climbing gyms in the current map view.',
