...
export default {
  ...
  'poi_categories.button': 'Show places on the map',
  'poi_categories.active': 'Shown on the map',
  'poi_categories.most_used': 'Most used',
  'poi_categories.all': 'All categories',
  'poi_categories.clear_all': 'Hide all (__count__)',
  'poi_categories.needs_zoom': 'needs zoom __zoom__+',
  'poi_categories.shown_count': 'Shown on the map: __count__',
  'poi_categories.zoom_in': 'Zoom in to load places',
  'poi_categories.load_error': 'Places could not be loaded, try moving the map.',
  'poi_categories.group.access': 'Access & transport',
  'poi_categories.group.water': 'Water',
  'poi_categories.group.food': 'Food & drink',
  'poi_categories.group.sleep': 'Sleeping',
  'poi_categories.group.hygiene': 'Hygiene',
  'poi_categories.group.outdoor': 'Hiking & nature',
  'poi_categories.group.services': 'Services',
  'poi_categories.group.emergency': 'Emergency',
  'poi_categories.category.parking': 'Parking',
  'poi_categories.category.bus_stop': 'Bus stop',
  'poi_categories.category.train_station': 'Train / tram station',
  'poi_categories.category.aerialway_station': 'Cable car station',
  'poi_categories.category.fuel': 'Petrol station',
  'poi_categories.category.charging_station': 'Charging station',
  'poi_categories.category.bicycle_parking': 'Bicycle parking',
  'poi_categories.category.drinking_water': 'Drinking water',
  'poi_categories.category.spring': 'Spring',
  'poi_categories.category.water_tap': 'Water tap',
  'poi_categories.category.water_well': 'Well',
  'poi_categories.category.restaurant': 'Restaurant',
  'poi_categories.category.pub': 'Pub & bar',
  'poi_categories.category.cafe': 'Café',
  'poi_categories.category.fast_food': 'Fast food',
  'poi_categories.category.grocery': 'Groceries',
  'poi_categories.category.bakery': 'Bakery',
  'poi_categories.category.ice_cream': 'Ice cream',
  'poi_categories.category.camp_site': 'Campsite',
  'poi_categories.category.caravan_site': 'Caravan site',
  'poi_categories.category.hut': 'Mountain hut',
  'poi_categories.category.shelter': 'Shelter',
  'poi_categories.category.lodging': 'Hotel & hostel',
  'poi_categories.category.toilets': 'Toilets',
  'poi_categories.category.shower': 'Shower',
  'poi_categories.category.waste_basket': 'Waste basket',
  'poi_categories.category.laundry': 'Laundry',
  'poi_categories.category.viewpoint': 'Viewpoint',
  'poi_categories.category.peak': 'Peak',
  'poi_categories.category.guidepost': 'Guidepost',
  'poi_categories.category.info_board': 'Information board',
  'poi_categories.category.picnic_site': 'Picnic site',
  'poi_categories.category.firepit': 'Firepit & BBQ',
  'poi_categories.category.bench': 'Bench',
  'poi_categories.category.cave_entrance': 'Cave entrance',
  'poi_categories.category.waterfall': 'Waterfall',
  'poi_categories.category.swimming': 'Swimming',
  'poi_categories.category.atm': 'ATM & bank',
  'poi_categories.category.pharmacy': 'Pharmacy',
  'poi_categories.category.doctor': 'Doctor',
  'poi_categories.category.outdoor_shop': 'Outdoor & sport shop',
  'poi_categories.category.bicycle_repair': 'Bicycle repair',
  'poi_categories.category.post': 'Post office',
  'poi_categories.category.mountain_rescue': 'Mountain rescue',
  'poi_categories.category.hospital': 'Hospital',
  'poi_categories.category.defibrillator': 'Defibrillator',
  'poi_categories.category.emergency_phone': 'Emergency phone',
  'poi_categories.category.police': 'Police',
  'poi_categories.category.fire_station': 'Fire station',
