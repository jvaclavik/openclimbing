...
export default {
  ...
  'offline.download_button': 'Download offline',
  'offline.updating': 'Updating…',
  'offline.downloading': 'Downloading… __percent__%',
  'offline.downloaded': 'Downloaded offline',
  'offline.update_button': 'Update',
  'offline.download_error': 'Saving failed',
  'offline.unsupported': 'Offline saving is not supported in this browser',
  'offline.you_are_offline': 'You are offline — showing saved data',
  'offline.menu_link': 'Offline areas',
  'offline.page_title': 'Offline areas',
  'offline.page_intro': 'Areas saved on this device. They stay available without a connection.',
  'offline.empty': 'No areas saved yet. Open a crag or area and tap “Save offline”.',
  'offline.delete': 'Delete',
  'offline.open': 'Open',
  'offline.features_count': '__count__ features',
  'offline.photos_count': '__count__ photos',
  'offline.storage_used': 'Downloaded areas use __used__',
  'offline.confirm_delete': 'Remove this saved area from the device?',
